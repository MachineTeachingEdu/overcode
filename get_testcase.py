...
def create_testcase(data, function_name):
    """
    Create a 'testCase.py' file with 'print(function_name(...))' statements for each string in the data.

    Args:
        data (list): A list of tuples containing strings.
        function_name (str): The name of the function to be applied to each line.
    ...
    print("Test cases saved to testCase.py!")


def get_testcase(problem_id):
    """
    ...
    with psycopg2.connect(**params) as connection:
        with connection.cursor() as cursor:
            ...
            if testcases is None:
                ...
                create_testcase(testcases, function_name[0][0])
