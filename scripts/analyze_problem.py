...
if the problem_<id> dir has a subdir called 'output', then the script should run replace_output_data function (from replace_output_data.py) with the <id> and '../ui' as argument.
Then it should run the run_interface function from run_interface.py.
